import { MenuRegistry, FrontEndApplication, LanguageNSRegistry, ThemeRegistry } from "@nubeio/flex-core";
...
export default class FlexUIApplication implements FrontEndApplication {
    ...
    constructor(menuRegistry: MenuRegistry, openHandler: flexCore.OpenHandler, nls: LanguageNSRegistry, themeRegistry: ThemeRegistry);
    initialize(): void;
}
